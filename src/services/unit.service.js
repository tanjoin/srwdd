...
export function parseUnitRow(row) {
  ...
  return {
    ...
    pilotId: row.pilotId || '',
    loadout: {
      abilityChipId: row.abilityChipId || row.loadout?.abilityChipId || '',
      mainPartId: row.mainPartId || row.loadout?.mainPartId || '',
      finisherPart1Id: row.finisherPart1Id || row.loadout?.finisherPart1Id || '',
      finisherPart2Id: row.finisherPart2Id || row.loadout?.finisherPart2Id || '',
      subPart1Id: row.subPart1Id || row.loadout?.subPart1Id || '',
      subPart2Id: row.subPart2Id || row.loadout?.subPart2Id || '',
      subPart3Id: row.subPart3Id || row.loadout?.subPart3Id || '',
      subPart4Id: row.subPart4Id || row.loadout?.subPart4Id || '',
    },
    size: row.size || '',
    type: row.type || '',
    hp,
...
export function flattenUnitForCSV(u) {
  ...
  return {
    ...
    abilityChipId: unit.loadout?.abilityChipId || '',
    mainPartId: unit.loadout?.mainPartId || '',
    finisherPart1Id: unit.loadout?.finisherPart1Id || '',
    finisherPart2Id: unit.loadout?.finisherPart2Id || '',
    subPart1Id: unit.loadout?.subPart1Id || '',
    subPart2Id: unit.loadout?.subPart2Id || '',
    subPart3Id: unit.loadout?.subPart3Id || '',
    subPart4Id: unit.loadout?.subPart4Id || '',
    size: unit.size || '',
    type: unit.type || '',
    hp: unit.hp || 0,
